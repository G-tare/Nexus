...
const BOOT_LINES = [
  ...
  { text: "> Loading 38 modules...", delay: 500 },
  { text: "> Mapping 368 command routes...", delay: 900 },
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden hex-grid">
      ...
      <div className="relative z-10 text-center max-w-4xl px-6">
        ...
        >
          ...
          <span className="text-[var(--hud-dim)]">38 MODULES ACTIVE</span>
          <span className="text-[var(--hud-dim)]">&bull;</span>
          <span className="text-[var(--hud-dim)]">368 COMMANDS LOADED</span>
        </motion.div>
        ...
        >
          38 modules. 360+ commands. One bot to rule them all. Stop juggling 10 bots &mdash; deploy Nexus.
        </motion.p>
      ...
      <div className="absolute bottom-6 left-6 right-6 flex justify-between z-10">
        <div className="flex gap-8">
          <DataReadout label="modules" value="38" />
          <DataReadout label="commands" value="368" />
        </div>
        <div className="flex gap-8">
      ...
      <div className="max-w-5xl mx-auto px-6">
        <HudFrame label="SYSTEM TELEMETRY" className="p-8 border border-[var(--hud-border)] bg-[var(--hud-bg-panel)] backdrop-blur">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <AnimatedStat value={38} label="Modules" />
            <AnimatedStat value={368} label="Commands" suffix="+" />
      ...
      <div className="max-w-7xl mx-auto px-6">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-center mb-12">
          ...
          <h2 className="text-4xl font-black mb-2">
            <span className="neon-text">38</span> Modules Loaded
          </h2>
      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}>
          ...
          <p className="text-[var(--hud-dim)] font-mono text-sm mb-10 max-w-lg mx-auto">
            One click. 38 modules. 360+ commands. Your server, upgraded.
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div>
            ...
            <p className="text-[11px] text-[var(--hud-dim)] mt-2 leading-relaxed">
              The ultimate all-in-one Discord bot. 38 modules. 360+ commands.
            </p>
          </div>
          <div>
